...
//Який принцип S.O.L.I.D. порушено? 
...
interface ILogger
{
    void Log(string emailFrom, string emailTo);
}

class Logger : ILogger
{
    public void Log(string emailFrom, string emailTo)
    {
        Console.WriteLine("Email from '" + emailFrom + "' to '" + emailTo + "' was send");
    }
}
...
class EmailSender
{
    ...
    {
        // ... sending...
        _logger.Log(email.From, email.To);
    }
}
